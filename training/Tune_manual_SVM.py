...
#------------------------------------------
f = open("pca_svm_experiments_log","w")  
# f = open("ica_svm_experiments_log","w")  
# f = open("umap_svm_experiments_log","w")  
# f = open("fs_svm_experiments_log","w")  
#--------------------------------------------
...
#                     "min_dist": d,
    ...
    f.write("For PCA n_compo="+str(n)+",from confusion matrix of PPMI testing set, best params are: \n")

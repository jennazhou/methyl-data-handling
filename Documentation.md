...
------------------
latent_dim=15
reconstruction_mean: = -0.07201654327525585
reconstruction_abssum: = -19437851.82078616
...
Current params:
{'gamma': 0.001, 'kernel': 'poly', 'coef0': 5, 'C': 0.1}
For classifier SVM :
Training cm is:
[[145 102]
 [162  85]]
...
-----------------
latent_dim = 30
reconstruction_mean: -0.07823520679914625
reconstruction_abssum: -21116319.77555457
...
{'gamma': 0.001, 'kernel': 'poly', 'coef0': 0.5, 'C': 10}
For classifier SVM :
Training cm is:
[[158  89]
 [163  84]]
...
XGB
{'num_estmtr': 20, 'col_ratio': 0.3, 'subsample_ratio': 0.4, 'max_depth': 4}
For classifier xgb :
Training cm is:
[[200  47]
 [ 63 184]]
...
{'num_estmtr': 20, 'col_ratio': 0.4, 'subsample_ratio': 0.3, 'max_depth': 2}
For classifier xgb :
Training cm is:
[[187  60]
 [ 88 159]]
...
{'num_estmtr': 40, 'col_ratio': 0.3, 'subsample_ratio': 0.7, 'max_depth': 3}
For classifier xgb :
Training cm is:
[[220  27]
 [ 39 208]]
...
-----------------
latent_dim = 50
reconstructed mean: -0.08012144978049286
reconstructed abssum: -21625432.125327837
...
SVM: (probably overfitted)
{'gamma': 0.1, 'kernel': 'poly', 'coef0': 0, 'C': 100}
For classifier xgb :
Training cm is:
[[184  63]
 [167  80]]
...
XGB:(likely to overfit)
Current params:
{'num_estmtr': 10, 'col_ratio': 0.5, 'subsample_ratio': 0.3, 'max_depth': 4}
For classifier xgb :
Training cm is:
[[190  57]
 [ 88 159]]
...
[[104  98]
 ...
 ---------------------
latent_dim = 80
reconstructed mean: -0.09228326179072946
reconstructed abssum: -24908004.28133495
...
SVM:
{'gamma': 1.5, 'kernel': 'poly', 'coef0': 10, 'C': 0.001}
For classifier SVM :
Training cm is:
[[216  31]
 [207  40]]
...
[[117  85]
 ...
 XGB:
 {'num_estmtr': 10, 'col_ratio': 0.3, 'subsample_ratio': 0.4, 'max_depth': 4}
For classifier xgb :
Training cm is:
[[200  47]
 [ 76 171]]
...
{'num_estmtr': 20, 'col_ratio': 0.3, 'subsample_ratio': 0.7, 'max_depth': 2}
For classifier xgb :
Training cm is:
[[211  36]
 [ 40 207]]
...
-----------------
latent_dim = 100
reconstructed mean: -0.09122033252806253
reconstructed abssum: -24621111.012593515
Final params:
{'C': 0.01}
Final testing cm is:
[[13 13]
...
{'gamma': 0.001, 'kernel': 'poly', 'coef0': 10, 'C': 0.001}
For classifier SVM :
Training cm is:
[[195  52]
 [211  36]]
...
{'num_estmtr': 20, 'col_ratio': 0.5, 'subsample_ratio': 0.5, 'max_depth': 4}
For classifier xgb :
Training cm is:
[[213  34]
 [ 42 205]]
